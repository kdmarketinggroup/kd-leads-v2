              ...
              <div key={index} className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className={`fade-up delay-200 ${isEven ? "lg:order-2" : "lg:order-1"}`}>
                  <div className="relative flex justify-center">
                    ...
                    <div className="relative scale-[0.8] lg:scale-[0.85] origin-top">
                            ...
                            <div className="p-6 pt-10 h-full flex flex-col">
                              <div className="flex-1 flex items-center justify-center">
                                ...
                                >
                                  {index === 0 && (
                                    <>
                                      <div className="bg-gradient-to-r from-[#d4af77]/20 to-[#c89d5f]/20 border border-[#d4af77]/30 rounded-2xl p-6">
                                  ...
                                  {index === 1 && (
                                    <div className="space-y-6">
                                      ...
                                      <div className="w-full bg-white/10 rounded-full h-2">
                                        <div
                                          className="bg-gradient-to-r from-[#d4af77] to-[#b88a4a] h-2 rounded-full"
                                          style={{ width: "72%" }}
                                        />
                                      </div>
                                    </div>
                                  ...
                                  {index === 2 && (
                                    <>
                                      <div className="bg-gradient-to-br from-[#d4af77]/20 to-[#c89d5f]/20 border border-[#d4af77]/30 rounded-2xl p-4">
                                  ...
                                  {index === 3 && (
                                    <>
                                      <div className="text-center">
                                        ...
                                        <h3 className="text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#d4af77] to-[#c89d5f]">
                                          $68,940
                                        </h3>
